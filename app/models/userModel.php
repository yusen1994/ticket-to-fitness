...
class userModel
{
  ...
  public function viewtimeTable($data)
  {
    ...
    $this->db->query('SELECT DISTINCT gym_activity_timetable.day, gym_activity_timetable.id, gym_activity_timetable.time, users_activity.activity_id, gym_activity.activity_name, gym_activity.category,gym_activity.sessions_per_week, gym_activity.max_capacity, gym_activity.credit, gym_activity.description, gym_information.gym_address
    FROM users_activity
