    ...
    <div class="row justify-content-center" style="background-color: white;">
        <div class="col-sm-1 col-lg-6">
            <div class="row" style="padding:0px; height:90px;">
                <div class="col-3 text-center userdashboard-menu-home p-4" style="padding:0px !important; height:auto;" id="userdashboard-menu-home">
                    <a href="<?php echo URLROOT ?>/User" class="menu-clickable" onclick="menuActive('home')">
                ...
                <div class="col-3 text-center userdashboard-menu-map p-4" style="padding:0px !important; height:auto;" id="userdashboard-menu-map">
                    <a href="#" class="menu-clickable" onclick="menuActive('map')">
                        <div class="menu-content">
                ...
                <div class="col-3 text-center userdashboard-menu-timetable p-4" style="padding:0px !important; height:auto;" id="userdashboard-menu-timetable">
                    <a href="<?php echo URLROOT ?>/User/Timetable" class="menu-clickable" onclick="menuActive('timetable')">
                        <div class="menu-content">
                ...
                <div class="col-3 text-center userdashboard-menu-social p-4" style="padding:0px !important; height:auto;" id="userdashboard-menu-social">
...
<script>
    function menuActive(menu) {
        switch (menu) {
            case "home":
                document.focus(document.getElementById("userdashboard-menu-home"));
                //             document.getElementById("userdashboard-menu-home").style.backgroundColor = "#ef8830";
                //             document.getElementById("userdashboard-menu-map").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-timetable").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-social").style.backgroundColor = "#ffffff";
                break;
                //         case "map":
                //             document.getElementById("userdashboard-menu-home").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-map").style.backgroundColor = "#ef8830";
                //             document.getElementById("userdashboard-menu-timetable").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-social").style.backgroundColor = "#ffffff";
                //             break;
            case "timetable":
                //             document.getElementById("userdashboard-menu-home").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-map").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-timetable").style.backgroundColor = "#ef8830";
                //             document.getElementById("userdashboard-menu-social").style.backgroundColor = "#ffffff";
                break;
                //         case "social":
                //             document.getElementById("userdashboard-menu-home").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-map").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-timetable").style.backgroundColor = "#ffffff";
                //             document.getElementById("userdashboard-menu-social").style.backgroundColor = "#ef8830";
                //             break;
        }
    }
</script>
...
<style>
    .userdashboard-menu-home:active {
        background-color: #ef8830;
    }

    .userdashboard-menu-map:active {
        background-color: #ef8830;
    }

    .userdashboard-menu-timetable:active {
        background-color: #ef8830;
    }

    .userdashboard-menu-social:active {
        background-color: #ef8830;
    }
