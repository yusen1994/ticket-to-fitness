        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="row mt-5">
                <div class="col-12" style="flex-direction: row;">
                    <h3><b><span><a href="<?php echo URLROOT; ?>/Administrator/dashboard"><i style="color:black;" class="fas fa-arrow-left"></i></a></span><span class="pl-2" style="color:black;">Members Overview</span></b></h3>
                </div>
            </div>
        </div>
    </div>
                    ...
                    echo '            <div class="gym-member">
                                         <div class="gym-member-construct">
                                          <div class="gym-member-name">' . $single->firstname . " " . $single->lastname . '</div>
                                           ...
                                           <div class="gym-member-active">';
                    if ($single->partnership_status) {
                        echo 'Partner Gym';
                    } else {
                        echo 'User';
                    }
