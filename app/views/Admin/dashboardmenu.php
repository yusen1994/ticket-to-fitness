            ...
            <div class="row" style="background-color:white; padding:0px; height:100px;">
                ...
                if (strpos($end, 'Gym') !== false || strpos($end, 'gym') !== false || strpos($end, 'members') !== false) {
                    ...
                    '
                     ...
                     <a href="' ?><?php echo URLROOT ?><?php echo '/Administrator/dashboard" class="menu-clickable">
                        <div class="menu-content">
                           <svg xmlns="http://www.w3.org/2000/svg" width="42.949" height="70.019" viewBox="0 0 42.949 70.019">
                            <g id="dashboard" transform="translate(0)">
                                <path id="Path_15" data-name="Path 15" d="M15.73,13.6H2.976A2.979,2.979,0,0,1,0,10.628V2.976A2.979,2.979,0,0,1,2.976,0H15.73a2.979,2.979,0,0,1,2.976,2.976v7.652A2.979,2.979,0,0,1,15.73,13.6ZM2.976,2.551a.425.425,0,0,0-.425.425v7.652a.425.425,0,0,0,.425.425H15.73a.426.426,0,0,0,.425-.425V2.976a.425.425,0,0,0-.425-.425Zm0,0" transform="translate(0 0)" fill="#f3f3f3"/>
                                <path id="Path_16" data-name="Path 16" d="M15.73,237.14H2.976A2.979,2.979,0,0,1,0,234.164V216.308a2.979,2.979,0,0,1,2.976-2.976H15.73a2.979,2.979,0,0,1,2.976,2.976v17.856A2.979,2.979,0,0,1,15.73,237.14ZM2.976,215.883a.425.425,0,0,0-.425.425v17.856a.425.425,0,0,0,.425.425H15.73a.425.425,0,0,0,.425-.425V216.308a.426.426,0,0,0-.425-.425Zm0,0" transform="translate(0 -194.191)" fill="#f3f3f3"/>
                                <path id="Path_17" data-name="Path 17" d="M293.062,354.937H280.308a2.979,2.979,0,0,1-2.976-2.976v-7.652a2.979,2.979,0,0,1,2.976-2.976h12.754a2.979,2.979,0,0,1,2.976,2.976v7.652A2.979,2.979,0,0,1,293.062,354.937Zm-12.754-11.054a.425.425,0,0,0-.425.425v7.652a.425.425,0,0,0,.425.425h12.754a.425.425,0,0,0,.425-.425v-7.652a.425.425,0,0,0-.425-.425Zm0,0" transform="translate(-253.089 -311.988)" fill="#f3f3f3"/>
                                <path id="Path_18" data-name="Path 18" d="M293.062,23.808H280.308a2.979,2.979,0,0,1-2.976-2.976V2.976A2.979,2.979,0,0,1,280.308,0h12.754a2.979,2.979,0,0,1,2.976,2.976V20.832A2.979,2.979,0,0,1,293.062,23.808ZM280.308,2.551a.425.425,0,0,0-.425.425V20.832a.425.425,0,0,0,.425.425h12.754a.425.425,0,0,0,.425-.425V2.976a.425.425,0,0,0-.425-.425Zm0,0" transform="translate(-253.089 0)" fill="#f3f3f3"/>
                            </g>
                            <text id="Home" transform="translate(39.975 66.019)" fill="#f3f3f3" font-size="12" font-family="Poppins-Bold, Poppins" font-weight="700" letter-spacing="0.008em"><tspan x="-36.786" y="0">Home</tspan></text>
                            </svg>
                    ...
                    ';
                                                        ...
                                                        echo '
                     <div class=" col-4 text-center" style="padding:0px !important; height:auto;">
                    <a href="' ?><?php echo URLROOT ?><?php echo '/Administrator/dashboard" class="menu-clickable">
                        <div class="menu-content">
                ...
                if (strpos($end, 'manageActivities') !== false) {
                    ...
                    <div class="col-4 text-center" style="padding:0px !important; height:auto;">
                     <a href="' ?><?php echo URLROOT ?><?php echo '/Administrator/manageActivities" class="menu-clickable">
                        <div class="menu-content">
                            <svg xmlns="http://www.w3.org/2000/svg" width="113" height="71.7" viewBox="0 0 113 71.7">
                                <text id="Manage_Activities" data-name="Manage Activities" transform="translate(113 67.7)" font-size="12" font-family="Poppins-Bold, Poppins" font-weight="700" letter-spacing="0.008em">
                                    <tspan x="-112.992" y="0">Manage Activities</tspan>
                                </text>
                                <g id="Page-1" transform="translate(11.475)">
                                    <g id="icon-18-weights" transform="translate(0)">
                ...
                $urlarray = explode("/", $url);
                $end = $urlarray[count($urlarray) - 1];
                $secondLast = $urlarray[count($urlarray) - 2];

                if (strpos($end, 'Timetable') !== false || strpos($secondLast, 'timetable') !== false) {
                    echo
                    '
                    <div class=" col-4 text-center gymdashboard-menu-active" style="padding:0px !important; height:auto;">
                     <a href="' ?><?php echo URLROOT ?><?php echo '/Administrator/Timetable" class="menu-clickable">
                        <div class="menu-content">
