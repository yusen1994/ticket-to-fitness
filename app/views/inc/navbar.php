  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbar4">
      <ul class="navbar-nav mr-auto pl-lg-4">
        ...
        <li class="nav-item px-lg-2"> <a class="nav-link" href="<?php echo URLROOT ?>/Landing/cart"><span class="d-inline-block d-lg-none icon-width"><svg xmlns="http://www.w3.org/2000/svg" width="20.657" height="20.807" viewBox="0 0 20.657 20.807">
