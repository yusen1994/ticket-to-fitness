        ...
        <div class="col-sm-12 col-lg-6">
            <div class="checkout-container" style="padding-top:10px;">
                <div class="row" style="margin-top:20px;">
                    <div class="col-9">
                        <span class="text-style">Credit Balance</span>
                    </div>
                    <div class="col-1">
                    ...
                    <div class="col-2">
                        <span class="text-style-bold">50</span>
                    </div>
                </div>
                <div class="row" style="margin-top:20px;">
                    <div class="col-9">
                    ...
                    <div class="col-2">
                        <span class="text-style-bold">45</span>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="row" style="margin-top:20px;">
                    <div class="col-9">
                        <span class="text-style-bold">Remaining</span>
                    </div>
                    <div class="col-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21.899" height="25.005" viewBox="0 0 21.899 25.005">
                            <g id="ticket_1_" data-name="ticket (1)" transform="matrix(0.105, -0.995, 0.995, 0.105, -0.206, 22.942)">
                    ...
                    <div class="col-2">
                        <span class="text-style-bold">5</span>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center" style="margin-top:20px;">
                ...
                <div class="col-5 col-lg-3 text-center">
                    <a class="checkout-confirm-btn" href="#">
                        Confirm
                    </a>
                </div>
            </div>
