            ...
            <div class="row" style="background-color:white; padding:0px; height:100px;">
                ...
                if (strpos($end, 'Gym') !== false || strpos($end, 'gym') !== false || strpos($end, 'members') !== false) {
                    ...
                    '
                     ...
                     <a href="' ?><?php echo URLROOT ?><?php echo '/gym" class="menu-clickable">
                ...
                if (strpos($end, 'manageActivities') !== false) {
                    echo '
                     <div class="col-4 text-center gymdashboard-menu-active" style="padding:0px !important; height:auto;">
                        <a href="' ?><?php echo URLROOT ?><?php echo '/Gym/manageActivities" class="menu-clickable">
                        <div class="menu-content">
                ...
                if (strpos($end, 'Timetable') !== false || strpos($secondLast, 'timetable') !== false) {
                    ...
                    '
                    <div class=" col-4 text-center gymdashboard-menu-active" style="padding:0px !important; height:auto;">
                     <a href="' ?><?php echo URLROOT ?><?php echo '/gym/Timetable" class="menu-clickable">
                        <div class="menu-content">
